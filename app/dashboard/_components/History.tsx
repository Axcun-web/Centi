    ...
    <div className="container mx-auto">
        ...
        <Card>
            <CardHeader className="gap-2">
                <CardTitle className="grid grid-flow-row 
                justify-between gap-2 md:grid-flow-col">
...
function CustomTooltip({ active, payload, formatter }: any) {
    ...
    return <div className="min-w-[300px] rounded border bg-background p-4">
      ...
      <TooltipRow formatter={formatter} label="Balance" value={income - expense} bgColor="bg-gray-100" textColor="text-gray-100" />
    </div>;
}
